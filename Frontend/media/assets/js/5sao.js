  ...
  function displayMovies() {
    ...
    if (moviesToDisplay.length === 0) {
      ...
      moviesToDisplay.forEach(function (movie) {
        let filmCard = `
          <div class="place__card" onclick="window.location.href='film_detail.html?courseId=${movie.courseId}'">
            <img src="${movie.thumbnailUrl}" alt="" class="place__img" />
            <div class="place__content">
              <div class="place__data">
                <h3 class="place__title">${movie.title}</h3>
                <span class="place__subtitle">${movie.language}, ${movie.duration} </span>
              </div>
            </div>
